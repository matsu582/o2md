...
o2mdは、Microsoft Office文書（Excel、Word、PowerPoint）、PDF、一太郎文書（.jtd/.jtt/.jsw/.jaw/.jtw/.jbw/.juw/.jfw/.jvw）、および画像ファイル（JPEG/PNG/GIF/BMP/TIFF/WebP）を**それっぽい**Markdown形式に変換するPythonツールです。ファイルの種類を自動判定し、適切な変換エンジンを使用して処理します。
